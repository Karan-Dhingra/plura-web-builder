                  ...
                  <CommandGroup>
                    {contactList.map((c) => (
                      <div 
                        ...
                        className={`relative flex cursor-default select-none items-center rounded-sm px-2 py-1.5 text-sm outline-none disabled:pointer-events-none ${c.id === contact && 'bg-primary font-bold text-white'} disabled:opacity-50`}
                      >
                        {c.name}
                        <CheckIcon
                          className={cn(
