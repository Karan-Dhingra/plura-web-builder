        ...
        >
            <div>
                ...
                <Popover>
                    ...
                    <PopoverContent className='w-80 h-[330px] mt-4 z-[200]'>
                        {
                                    ...
                                    {(user?.role === 'AGENCY_OWNER' || user?.role === "AGENCY_ADMIN")
                                        ...
                                        <CommandGroup heading="Accounts">
                                            ...
                                            ? subAccounts?.map((subaccount) => (
                                                <CommandItem key={subaccount.id} className='!bg-transparent my-2 text-primary border-[1px] border-border p-2 rounded-md hover:!bg-muted cursor-pointer transition-all'>
                                                    {defaultOpen
